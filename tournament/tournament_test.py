...
if __name__ == '__main__':
    ...
    for tournament in [1, 2, 3, 4]:
        print "\nTesting for tournament {0}".format(tournament)
        testCount(tournament)
        testStandingsBeforeMatches(tournament)
        testReportMatches(tournament)
        testPairings(tournament)
